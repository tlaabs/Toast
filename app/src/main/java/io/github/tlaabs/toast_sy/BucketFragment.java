...
public class BucketFragment extends Fragment{
    static final String LOG = "ALARM_NOTI";
        ...
        public void onBindViewHolder(@NonNull ListHolder holder, int position) {
            ...
            holder.onGoingBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    recordValues.put("STATE", 1); //toDO : state종류별로 지정해야한다
                    ...
                    if(!item.getUsageTime().equals("-")) {
                        howlong = Integer.parseInt(item.getUsageTime());
                        ...
                        Log.v("--item UPDATE---",item.getId()+" ths Item "+item.getTitle());
